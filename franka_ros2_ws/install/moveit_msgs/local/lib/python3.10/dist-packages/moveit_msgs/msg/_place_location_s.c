...
bool moveit_msgs__msg__place_location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._place_location.PlaceLocation", full_classname_dest, 45) == 0);
  }
  moveit_msgs__msg__PlaceLocation * ros_message = _ros_message;
  {  // id
  ...
  {  // post_place_posture
    PyObject * field = PyObject_GetAttrString(_pymsg, "post_place_posture");
    if (!field) {
      return false;
    }
    if (!trajectory_msgs__msg__joint_trajectory__convert_from_py(field, &ros_message->post_place_posture)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // pre_place_approach
    PyObject * field = PyObject_GetAttrString(_pymsg, "pre_place_approach");
    if (!field) {
      return false;
    }
    if (!moveit_msgs__msg__gripper_translation__convert_from_py(field, &ros_message->pre_place_approach)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of PlaceLocation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_msgs.msg._place_location");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlaceLocation");
  ...
  {  // post_place_posture
    PyObject * field = NULL;
    field = trajectory_msgs__msg__joint_trajectory__convert_to_py(&ros_message->post_place_posture);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "post_place_posture", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pre_place_approach
    PyObject * field = NULL;
    field = moveit_msgs__msg__gripper_translation__convert_to_py(&ros_message->pre_place_approach);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "pre_place_approach", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
