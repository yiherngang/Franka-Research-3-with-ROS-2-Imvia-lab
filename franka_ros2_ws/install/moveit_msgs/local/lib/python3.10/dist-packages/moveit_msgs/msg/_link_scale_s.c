...
bool moveit_msgs__msg__link_scale__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._link_scale.LinkScale", full_classname_dest, 37) == 0);
  }
  moveit_msgs__msg__LinkScale * ros_message = _ros_message;
  {  // link_name
...
{
  /* NOTE(esteve): Call constructor of LinkScale */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_msgs.msg._link_scale");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LinkScale");
