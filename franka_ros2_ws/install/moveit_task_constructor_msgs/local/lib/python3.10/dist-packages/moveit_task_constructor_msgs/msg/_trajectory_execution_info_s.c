...
bool moveit_task_constructor_msgs__msg__trajectory_execution_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_task_constructor_msgs.msg._trajectory_execution_info.TrajectoryExecutionInfo", full_classname_dest, 83) == 0);
  }
  moveit_task_constructor_msgs__msg__TrajectoryExecutionInfo * ros_message = _ros_message;
  {  // controller_names
...
{
  /* NOTE(esteve): Call constructor of TrajectoryExecutionInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_task_constructor_msgs.msg._trajectory_execution_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryExecutionInfo");
