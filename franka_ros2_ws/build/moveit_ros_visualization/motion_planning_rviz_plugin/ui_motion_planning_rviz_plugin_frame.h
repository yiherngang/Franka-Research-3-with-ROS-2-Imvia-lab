...
public:
    ...
    {
        MotionPlanningUI->setWindowTitle(QCoreApplication::translate("MotionPlanningUI", "MoveIt Planning Frame", nullptr));
        groupBox1->setTitle(QCoreApplication::translate("MotionPlanningUI", "Planning Library", nullptr));
        library_label->setText(QCoreApplication::translate("MotionPlanningUI", "Planning Library Name", nullptr));
        label_15->setText(QCoreApplication::translate("MotionPlanningUI", "Planner Parameters", nullptr));
        groupBox2->setTitle(QCoreApplication::translate("MotionPlanningUI", "Warehouse", nullptr));
        label_2->setText(QCoreApplication::translate("MotionPlanningUI", "Host:", nullptr));
        database_host->setText(QString());
        label_3->setText(QCoreApplication::translate("MotionPlanningUI", "Port:", nullptr));
        reset_db_button->setText(QCoreApplication::translate("MotionPlanningUI", "Reset database ...", nullptr));
        database_connect_button->setText(QCoreApplication::translate("MotionPlanningUI", "Connect", nullptr));
        groupBox_6->setTitle(QCoreApplication::translate("MotionPlanningUI", "Workspace", nullptr));
        label_21->setText(QCoreApplication::translate("MotionPlanningUI", "Center (XYZ):", nullptr));
        label_22->setText(QCoreApplication::translate("MotionPlanningUI", "Size (XYZ):", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(context), QCoreApplication::translate("MotionPlanningUI", "Context", nullptr));
        groupBox_9->setTitle(QCoreApplication::translate("MotionPlanningUI", "Commands", nullptr));
        plan_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Plan", nullptr));
        execute_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Execute", nullptr));
        plan_and_execute_button->setText(QCoreApplication::translate("MotionPlanningUI", "Plan && E&xecute", nullptr));
#if QT_CONFIG(tooltip)
        stop_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Stop execution by sending a stop command to the move_group.", nullptr));
#endif // QT_CONFIG(tooltip)
        stop_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Stop", nullptr));
        result_label->setText(QString());
        clear_octomap_button->setText(QCoreApplication::translate("MotionPlanningUI", "Clear octomap", nullptr));
        groupBox_11->setTitle(QCoreApplication::translate("MotionPlanningUI", "Query", nullptr));
        label_planning_group->setText(QCoreApplication::translate("MotionPlanningUI", "Planning Group:", nullptr));
        label_start_state->setText(QCoreApplication::translate("MotionPlanningUI", "Start State:", nullptr));
        label_goal_state->setText(QCoreApplication::translate("MotionPlanningUI", "Goal State:", nullptr));
        groupBox_12->setTitle(QCoreApplication::translate("MotionPlanningUI", "Path Constraints", nullptr));
#if QT_CONFIG(tooltip)
        path_constraints_combo_box->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Select path constraints from the database. ", nullptr));
#endif // QT_CONFIG(tooltip)
        groupBox_10->setTitle(QCoreApplication::translate("MotionPlanningUI", "Options", nullptr));
#if QT_CONFIG(tooltip)
        label_9->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Total time allowed for planning.  Planning stops if time or number of attempts is exceeded, or goal is reached.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_9->setText(QCoreApplication::translate("MotionPlanningUI", "Planning Time (s):", nullptr));
#if QT_CONFIG(tooltip)
        planning_time->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Total time allowed for planning.  Planning stops if time or number of attempts is exceeded, or goal is reached.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        label_10->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Allowed number of planning attempts. Planning stops if time or number of attempts is exceeded, or goal is reached.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_10->setText(QCoreApplication::translate("MotionPlanningUI", "Planning Attempts:", nullptr));
#if QT_CONFIG(tooltip)
        planning_attempts->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Allowed number of planning attempts. Planning stops if time or number of attempts is exceeded, or goal is reached.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        label_11->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint velocities", nullptr));
#endif // QT_CONFIG(tooltip)
        label_11->setText(QCoreApplication::translate("MotionPlanningUI", "Velocity Scaling:", nullptr));
#if QT_CONFIG(tooltip)
        velocity_scaling_factor->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint velocities", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        label_20->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint accelerations", nullptr));
#endif // QT_CONFIG(tooltip)
        label_20->setText(QCoreApplication::translate("MotionPlanningUI", "Accel. Scaling:", nullptr));
#if QT_CONFIG(tooltip)
        acceleration_scaling_factor->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Factor (between 0 and 1) to scale down maximum joint accelerations", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        use_cartesian_path->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Check this to generate a linear path in Cartesian (3D) space.\n"
"\n"
" This does not plan around obstacles. ", nullptr));
#endif // QT_CONFIG(tooltip)
        use_cartesian_path->setText(QCoreApplication::translate("MotionPlanningUI", "Use Cartesian Path", nullptr));
#if QT_CONFIG(tooltip)
        collision_aware_ik->setToolTip(QCoreApplication::translate("MotionPlanningUI", "If checked, the IK solver tries to avoid collisions when searching for a start/end state set via the interactive marker.\n"
"\n"
...
#endif // QT_CONFIG(tooltip)
        collision_aware_ik->setText(QCoreApplication::translate("MotionPlanningUI", "Collision-aware IK", nullptr));
#if QT_CONFIG(tooltip)
        approximate_ik->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Allow approximate IK solutions, which deviate from the target pose. Useful when an exact solution cannot be found, e.g. for underactuated arms or when trying to reach an unreachable target.", nullptr));
#endif // QT_CONFIG(tooltip)
        approximate_ik->setText(QCoreApplication::translate("MotionPlanningUI", "Approx IK Solutions", nullptr));
#if QT_CONFIG(tooltip)
        allow_external_program->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Allow other nodes to control start and end poses as well as planning and execution, using ROS topics (/rviz/moveit/ ).", nullptr));
#endif // QT_CONFIG(tooltip)
        allow_external_program->setText(QCoreApplication::translate("MotionPlanningUI", "External Comm.", nullptr));
#if QT_CONFIG(tooltip)
        allow_replanning->setToolTip(QCoreApplication::translate("MotionPlanningUI", "EXPERIMENTAL: Trigger replanning if new collisions are detected during plan execution. Only works for the \"Plan & Execute\" button. ", nullptr));
#endif // QT_CONFIG(tooltip)
        allow_replanning->setText(QCoreApplication::translate("MotionPlanningUI", "Replanning", nullptr));
#if QT_CONFIG(tooltip)
        allow_looking->setToolTip(QCoreApplication::translate("MotionPlanningUI", "EXPERIMENTAL: Allows the robot to reposition its sensor to look around to resolve apparent collisions. A sensor needs to be set up and the new measurements have to affect the collision scene, otherwise it has no effect. See tutorial.", nullptr));
#endif // QT_CONFIG(tooltip)
        allow_looking->setText(QCoreApplication::translate("MotionPlanningUI", "Sensor Positioning", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(planning), QCoreApplication::translate("MotionPlanningUI", "Planning", nullptr));
        groupBox_8->setTitle(QCoreApplication::translate("MotionPlanningUI", "Current Scene Objects", nullptr));
#if QT_CONFIG(tooltip)
        collision_objects_list->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Press Ctrl+C to duplicate an object", nullptr));
#endif // QT_CONFIG(tooltip)
        groupBox_4->setTitle(QCoreApplication::translate("MotionPlanningUI", "Add/Remove scene object(s)", nullptr));
#if QT_CONFIG(tooltip)
        shape_size_x_spin_box->setToolTip(QCoreApplication::translate("MotionPlanningUI", "x dimension", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        shape_size_y_spin_box->setToolTip(QCoreApplication::translate("MotionPlanningUI", "y dimension", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        shape_size_z_spin_box->setToolTip(QCoreApplication::translate("MotionPlanningUI", "z dimension", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        add_object_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Add object at scene's origin", nullptr));
#endif // QT_CONFIG(tooltip)
        add_object_button->setText(QCoreApplication::translate("MotionPlanningUI", "Add", nullptr));
#if QT_CONFIG(tooltip)
        remove_object_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Remove selected object", nullptr));
#endif // QT_CONFIG(tooltip)
        remove_object_button->setText(QCoreApplication::translate("MotionPlanningUI", "Del", nullptr));
#if QT_CONFIG(tooltip)
        clear_scene_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Clear planning scene", nullptr));
#endif // QT_CONFIG(tooltip)
        clear_scene_button->setText(QCoreApplication::translate("MotionPlanningUI", "Clr", nullptr));
#if QT_CONFIG(tooltip)
        pose_scale_group_box->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Change the pose and scale of the selected object", nullptr));
#endif // QT_CONFIG(tooltip)
        pose_scale_group_box->setTitle(QCoreApplication::translate("MotionPlanningUI", "Change object pose/scale", nullptr));
        label_4->setText(QCoreApplication::translate("MotionPlanningUI", "Position: ", nullptr));
        label_13->setText(QCoreApplication::translate("MotionPlanningUI", "Rotation:", nullptr));
        label->setText(QCoreApplication::translate("MotionPlanningUI", "Scale:", nullptr));
        label_17->setText(QCoreApplication::translate("MotionPlanningUI", "0%", nullptr));
        label_18->setText(QCoreApplication::translate("MotionPlanningUI", "200%", nullptr));
#if QT_CONFIG(tooltip)
        groupBox_5->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Describes the selected object's pose, geometry and subframes.", nullptr));
#endif // QT_CONFIG(tooltip)
        groupBox_5->setTitle(QCoreApplication::translate("MotionPlanningUI", "Object status", nullptr));
        object_status->setText(QCoreApplication::translate("MotionPlanningUI", "Status", nullptr));
        groupBox3->setTitle(QCoreApplication::translate("MotionPlanningUI", "Scene Geometry", nullptr));
        publish_current_scene_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Publish", nullptr));
#if QT_CONFIG(tooltip)
        export_scene_geometry_text_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Export scene geometry to a .scene file (only world object information is preserved)", nullptr));
#endif // QT_CONFIG(tooltip)
        export_scene_geometry_text_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Export", nullptr));
#if QT_CONFIG(tooltip)
        import_scene_geometry_text_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Import scene geometry from a .scene file (only world object information is preserved)", nullptr));
#endif // QT_CONFIG(tooltip)
        import_scene_geometry_text_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Import", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(scene_collision_objects), QCoreApplication::translate("MotionPlanningUI", "Scene Objects", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("MotionPlanningUI", "Planning Scenes and Queries", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = planning_scene_tree->headerItem();
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("MotionPlanningUI", "1", nullptr));
        groupBox->setTitle(QCoreApplication::translate("MotionPlanningUI", "Saved Scenes", nullptr));
        load_scene_button->setText(QCoreApplication::translate("MotionPlanningUI", "Load &Scene", nullptr));
        load_query_button->setText(QCoreApplication::translate("MotionPlanningUI", "Load &Query", nullptr));
        delete_scene_button->setText(QCoreApplication::translate("MotionPlanningUI", "Delete Scene", nullptr));
        delete_query_button->setText(QCoreApplication::translate("MotionPlanningUI", "Delete Query", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("MotionPlanningUI", "Current Scene", nullptr));
        save_scene_button->setText(QCoreApplication::translate("MotionPlanningUI", "Save Scene", nullptr));
        save_query_button->setText(QCoreApplication::translate("MotionPlanningUI", "Save Query", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(stored_plans), QCoreApplication::translate("MotionPlanningUI", "Stored Scenes", nullptr));
        groupBox_15->setTitle(QCoreApplication::translate("MotionPlanningUI", "Stored Robot States", nullptr));
#if QT_CONFIG(tooltip)
        load_state_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Load a robot state", nullptr));
#endif // QT_CONFIG(tooltip)
        load_state_button->setText(QCoreApplication::translate("MotionPlanningUI", "Load", nullptr));
#if QT_CONFIG(tooltip)
        clear_states_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Clear robot states from list", nullptr));
#endif // QT_CONFIG(tooltip)
        clear_states_button->setText(QCoreApplication::translate("MotionPlanningUI", "Clear", nullptr));
        groupBox_16->setTitle(QCoreApplication::translate("MotionPlanningUI", "Selected Robot State", nullptr));
        set_as_start_state_button->setText(QCoreApplication::translate("MotionPlanningUI", "Set as Start", nullptr));
        set_as_goal_state_button->setText(QCoreApplication::translate("MotionPlanningUI", "Set as Goal", nullptr));
        remove_state_button->setText(QCoreApplication::translate("MotionPlanningUI", "Remove", nullptr));
        groupBox_17->setTitle(QCoreApplication::translate("MotionPlanningUI", "Current Robot State", nullptr));
#if QT_CONFIG(tooltip)
        save_start_state_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Save the current start state", nullptr));
#endif // QT_CONFIG(tooltip)
        save_start_state_button->setText(QCoreApplication::translate("MotionPlanningUI", "Save Start", nullptr));
#if QT_CONFIG(tooltip)
        save_goal_state_button->setToolTip(QCoreApplication::translate("MotionPlanningUI", "Save the current goal state", nullptr));
#endif // QT_CONFIG(tooltip)
        save_goal_state_button->setText(QCoreApplication::translate("MotionPlanningUI", "Save Goal", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(stored_states), QCoreApplication::translate("MotionPlanningUI", "Stored States", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(status), QCoreApplication::translate("MotionPlanningUI", "Status", nullptr));
        groupBox_13->setTitle(QCoreApplication::translate("MotionPlanningUI", "Detected Objects", nullptr));
        detect_objects_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Detect", nullptr));
        groupBox_14->setTitle(QCoreApplication::translate("MotionPlanningUI", "Support Surfaces", nullptr));
        place_button->setText(QCoreApplication::translate("MotionPlanningUI", "P&lace", nullptr));
        pick_button->setText(QCoreApplication::translate("MotionPlanningUI", "&Pick", nullptr));
        groupBox_7->setTitle(QCoreApplication::translate("MotionPlanningUI", "ROI", nullptr));
        label_14->setText(QCoreApplication::translate("MotionPlanningUI", "Size (m): ", nullptr));
        label_12->setText(QCoreApplication::translate("MotionPlanningUI", "Center (m): ", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(manipulation), QCoreApplication::translate("MotionPlanningUI", "Manipulation", nullptr));
#if QT_CONFIG(whatsthis)
        background_job_progress->setWhatsThis(QCoreApplication::translate("MotionPlanningUI", "<html><head/><body><p>Progress of background jobs</p></body></html>", nullptr));
