...
bool moveit_msgs__msg__trajectory_constraints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._trajectory_constraints.TrajectoryConstraints", full_classname_dest, 61) == 0);
  }
  moveit_msgs__msg__TrajectoryConstraints * ros_message = _ros_message;
  {  // constraints
    ...
    moveit_msgs__msg__Constraints * dest = ros_message->constraints.data;
...
{
  /* NOTE(esteve): Call constructor of TrajectoryConstraints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_msgs.msg._trajectory_constraints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajectoryConstraints");
