...
class Metaclass_GenericTrajectory(type):
    """Metaclass of message 'GenericTrajectory'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__generic_trajectory
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__generic_trajectory
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__generic_trajectory
            cls._TYPE_SUPPORT = module.type_support_msg__msg__generic_trajectory
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__generic_trajectory
...
class GenericTrajectory(metaclass=Metaclass_GenericTrajectory):
    """Message class 'GenericTrajectory'."""
    ...
    _fields_and_field_types = {
        ...
        'joint_trajectory': 'sequence<trajectory_msgs/JointTrajectory>',
        'cartesian_trajectory': 'sequence<moveit_msgs/CartesianTrajectory>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['moveit_msgs', 'msg'], 'CartesianTrajectory')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.cartesian_trajectory = kwargs.get('cartesian_trajectory', [])
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'joint_trajectory' field must be a set or sequence and each value of type 'JointTrajectory'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'cartesian_trajectory' field must be a set or sequence and each value of type 'CartesianTrajectory'"
