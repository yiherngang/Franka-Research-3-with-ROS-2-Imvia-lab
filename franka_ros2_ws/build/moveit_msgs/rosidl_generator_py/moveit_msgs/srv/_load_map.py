...
class Metaclass_LoadMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from moveit_msgs.srv import _load_map
...
class LoadMap(metaclass=Metaclass_LoadMap):
    from moveit_msgs.srv._load_map import LoadMap_Request as Request
    from moveit_msgs.srv._load_map import LoadMap_Response as Response
