...
bool moveit_msgs__msg__planner_params__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._planner_params.PlannerParams", full_classname_dest, 45) == 0);
  }
  moveit_msgs__msg__PlannerParams * ros_message = _ros_message;
  {  // keys
  ...
  {  // values
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->values.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // descriptions
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->descriptions.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of PlannerParams */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_msgs.msg._planner_params");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlannerParams");
  ...
  {  // values
    ...
    rosidl_runtime_c__String * src = ros_message->values.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // descriptions
    ...
    rosidl_runtime_c__String * src = ros_message->descriptions.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
