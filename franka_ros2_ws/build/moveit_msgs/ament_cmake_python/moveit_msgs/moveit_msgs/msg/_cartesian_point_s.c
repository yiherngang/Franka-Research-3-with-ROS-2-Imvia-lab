...
bool moveit_msgs__msg__cartesian_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_msgs.msg._cartesian_point.CartesianPoint", full_classname_dest, 47) == 0);
  }
  moveit_msgs__msg__CartesianPoint * ros_message = _ros_message;
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of CartesianPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_msgs.msg._cartesian_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CartesianPoint");
