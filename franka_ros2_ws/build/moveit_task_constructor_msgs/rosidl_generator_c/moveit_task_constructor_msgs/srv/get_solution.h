...
#ifndef MOVEIT_TASK_CONSTRUCTOR_MSGS__SRV__GET_SOLUTION_H_
#define MOVEIT_TASK_CONSTRUCTOR_MSGS__SRV__GET_SOLUTION_H_
...
#endif  // MOVEIT_TASK_CONSTRUCTOR_MSGS__SRV__GET_SOLUTION_H_
