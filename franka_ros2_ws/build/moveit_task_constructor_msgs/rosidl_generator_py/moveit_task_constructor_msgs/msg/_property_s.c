...
bool moveit_task_constructor_msgs__msg__property__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_task_constructor_msgs.msg._property.Property", full_classname_dest, 51) == 0);
  }
  moveit_task_constructor_msgs__msg__Property * ros_message = _ros_message;
  {  // name
...
PyObject * moveit_task_constructor_msgs__msg__property__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_task_constructor_msgs.msg._property");
