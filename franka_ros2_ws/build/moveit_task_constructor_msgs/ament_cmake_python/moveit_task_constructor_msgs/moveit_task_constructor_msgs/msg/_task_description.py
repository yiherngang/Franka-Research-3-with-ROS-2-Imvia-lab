...
class Metaclass_TaskDescription(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from moveit_task_constructor_msgs.msg import StageDescription
            if StageDescription.__class__._TYPE_SUPPORT is None:
                StageDescription.__class__.__import_type_support__()
...
class TaskDescription(metaclass=Metaclass_TaskDescription):
    ...
    _fields_and_field_types = {
        'task_id': 'string',
        'stages': 'sequence<moveit_task_constructor_msgs/StageDescription>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['moveit_task_constructor_msgs', 'msg'], 'StageDescription')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, StageDescription) for v in value) and
                 True), \
                "The 'stages' field must be a set or sequence and each value of type 'StageDescription'"
        self._stages = value
