...
#define NODE_MAIN_LOGGER_NAME "franka_gripper_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgripper_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<franka_gripper::GripperActionServer>";
