...
#define VISP_RUBIK_REGULAR_FONT_RESOURCES "/usr/local/share/visp-3.6.1/data/font/Rubik-Regular.ttf"

// Defined the path to the basic scenes used by the simulator
#define VISP_SCENES_DIR "/usr/local/share/visp-3.6.1/data/wireframe-simulator"

// Defined the path to the robot's arms 3D model used by the robot simulators
#define VISP_ROBOT_ARMS_DIR "/usr/local/share/visp-3.6.1/data/robot-simulator"
...
#define VISP_HAVE_OGRE_RESOURCES_PATH "/usr/local/share/visp-3.6.1/data/ogre-simulator"
