...
static const _FrankaRobotState_type_support_symbol_names_t _FrankaRobotState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_msgs, msg, FrankaRobotState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, franka_msgs, msg, FrankaRobotState)),
  }
};
...
{
  return &::franka_msgs::msg::rosidl_typesupport_cpp::FrankaRobotState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, franka_msgs, msg, FrankaRobotState)() {
  return get_message_type_support_handle<franka_msgs::msg::FrankaRobotState>();
}
